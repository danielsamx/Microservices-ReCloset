...
<template>
  <div v-if="message || list.length"
    class="bg-rose-50 border border-rose-100 text-rose-700 rounded-xl p-3 mb-4 animate-pop" role="alert" aria-live="assertive">
    <div class="flex items-start gap-2">
      ...
      <div class="min-w-0 flex-1">
        ...
        <ul v-if="list.length" class="mt-1 space-y-0.5">
          <li v-for="(e, i) in list" :key="i" class="text-sm text-rose-600 flex gap-1.5">
