...
<template>
  <div>
    ...
    <div class="flex items-center gap-3 mt-2">
      ...
      <span class="text-xs ml-auto" :class="error ? 'text-rose-500' : 'text-slate-400'">
...
.chip-off:hover { border-color: #99f6e4; background: #f0fdfa; color: #0f766e; }
.chip-on { background: #0f766e; border-color: #0f766e; color: #fff; box-shadow: 0 4px 12px -4px rgba(13,148,136,.6); }
</style>
